  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-800 flex items-center justify-center p-8">
      <div className="w-full max-w-lg bg-[#1f2033] rounded-3xl shadow-2xl p-8 animate-fadeIn">
        {/* Header */}
        <h1 className="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 via-orange-500 to-pink-500 mb-6 text-center">
          Edit Problem
        </h1>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <button
            type="submit"
            className="bg-gradient-to-r from-yellow-400 via-orange-500 to-pink-500 hover:from-pink-500 hover:via-orange-500 hover:to-yellow-400 text-white font-semibold p-3 rounded-xl shadow-lg transition transform hover:-translate-y-1 hover:scale-105"
          >
            Update Problem
          </button>
